...
use Websm\Framework\NoSQL\MemcachedConnection;
...
class MemcachedCache implements CacheItemPoolInterface {
    ...
    public function __construct(MemcachedConnection $conection, $prefix = '') {
    ...
    public function getItem($key) {
        ...
        $item = false;
        $value = $this->conection->get($this->prefix.$key);
    ...
    public function clear() {
        ...
        $keys = $this->conection->getAllKeys();

        foreach ($keys as $key) {

            if (preg_match($pattern, $key)) $this->deleteItem($key);
    ...
    public function save(CacheItemInterface $item) {
        ...
        $result = $this->conection->set($key, $value);
