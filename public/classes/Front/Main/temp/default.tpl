		...
		<div class="welcome__laptop">
			...
			<div class="example__laptop">
				...
				<div class="laptop__number">
					<div class="laptop__number_title">8 (8212) 26-40-00</div>
					<div class="laptop__number_title">8 (8212) 40-00-70</div>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="popular">
		<div class="wrapper">
			<div class="popular__block">
				<div class="popular__block_title">
					<h2 class="title_main">Популярные товары</h2>
					<p class="title_description">Проверенное качество товаров для наших покупателей</p>
				</div>
				<div class="popular__block_cards">
					<form class="choose" action=""><input class="for__all custom-radio" id="for__all_popular" type="radio" name="take"> <label class="for__all_label" for="for__all_popular">Все
							товары</label> <input class="for__hunting custom-radio" id="for__hunting_popular" type="radio" name="take"> <label class="for__hunting_label" for="for__hunting_popular">Для охоты</label> <input class="for__fishing custom-radio" id="for__fishing_popular" type="radio" name="take"> <label class="for__fishing_label" for="for__fishing_popular">Для рыбалки</label> <input class="for__tourism custom-radio" id="for__tourism_popular" type="radio" name="take"> <label class="for__tourism_label" for="for__tourism_popular">Для туризма</label></form>
