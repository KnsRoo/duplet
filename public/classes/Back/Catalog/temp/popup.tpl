<div class="options-popup absolute hidden">
	...
	<div class="popup-cont">
		...
		<div class="calend">
			<p>Отображать товары добавленные в определенное время:</p>
		...
		<span onclick="layout.checkAll();">Отметить все товары</span><span>&ensp;/&ensp;</span><span onclick="layout.uncheckAll();">Снять отметки со всех товаров</span>
		<p>Дейсвия с отмеченными товарами:</p>
